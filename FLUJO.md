 # Flujos de Usuario - ProTalent
     ...
     Este documento mapea los flujos de procesos completos que cada tipo de usuario debe seguir para
     utilizar eficazmente la plataforma ProTalent. La plataforma maneja cuatro tipos de usuarios
     principales: **Estudiantes**, **Empresas**, **Instituciones** y **Administradores**.
     ...
     **Capacidades:**
     ...
     Este mapeo de flujos servirá como base para diseñar interfaces intuitivas que guíen efectivamente a 
     cada tipo de usuario a través de sus procesos específicos, minimizando la fricción y maximizando el 
     valor obtenido de la plataforma.